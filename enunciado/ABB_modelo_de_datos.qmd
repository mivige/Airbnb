...
Por último de los comunes seleccionamos unas cuantas variables para hacer un 
análisis exploratorio, PERO CUIDADO, notemos que hemos perdido información de las fechas de los reviews, por lo que deberíamos de tener cuidado con el análisis que hagamos con estas variables y de algunas variables como `price`.
